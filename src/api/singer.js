...
export function getSinger({limit = 30, offset = 0, type = -1, area = -1,initial}, cancelToken) {
    const url = "/artist/list";
    return request({url, method: "get", params: {limit, offset, type, area,initial}, cancelToken});
}
